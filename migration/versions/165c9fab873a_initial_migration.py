...
def upgrade() -> None:
    """Upgrade schema."""
    # users must be created first — offers.user_id has a FK to users.id
    ...
    op.create_index('ux_offer_user_hash', 'offers', ['user_id', 'search_hash'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index('ux_offer_user_hash', table_name='offers')
